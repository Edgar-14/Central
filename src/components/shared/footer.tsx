...
export function Footer() {
  ...
  return (
    <footer className="bg-white/30 dark:bg-black/20 border-t">
      <div className="container mx-auto px-4 py-12 md:px-6">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
          <div className="lg:col-span-1">
            <Logo />
            <p className="mt-4 text-sm text-muted-foreground">
              La plataforma central para la gestión de nuestra flota de repartidores.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:col-span-3 gap-8">
            <div>
